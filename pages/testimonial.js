...
const Testimonial = () => {
    ...
    return (
        <Layout>
            <Head>
                <title>Customer Reviews || NextDev Labs</title>
            </Head>
                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-8 col-md-8 col-sm-8 col-12">
                                <div className="section-title text-start">
                                    ...
                                    Hear from businesses that have transformed their digital presence with NextDev Labs.  
                                    We strive for excellence in every project we deliver.
                                    </p>
                                </div>
                            </div>
