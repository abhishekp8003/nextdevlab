              ...
              <div className="row align-items-center">
                <div className="col-lg-5 order-2 order-lg-1 mt_md--30 mt_sm--30">
                  <div className="inner">
                    ...
                    <p>
                      Grow your business online by awesomely designed mobile
                      apps that fits all types.
                    </p>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-lg-12">
                  <SectionTitle
                    ...
                    description="At NextDev Labs, we're more than just a startup—we're a movement dedicated to empowering the next generation of developers, innovators, and creators. Born from a passion for technology and community, our mission is to nurture talent, inspire innovation, and foster collaboration.

We believe great ideas deserve great support. That's why we provide aspiring developers and tech entrepreneurs with the tools, resources, and mentorship needed to transform their concepts into impactful solutions. From immersive workshops and hackathons to cutting-edge incubation programs, NextDev Labs is committed to cultivating a dynamic ecosystem that accelerates growth and ignites creativity.

Join us as we push boundaries, build connections, and pave the way for a brighter, tech-driven future. At NextDev Labs, the future of development starts now."
                    color="extra08-color"
                    alignment="center"
                  />
                </div>
