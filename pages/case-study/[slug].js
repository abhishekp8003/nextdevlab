...
export async function getStaticProps({params}) {
    const caseStudy = CaseStudiesData.find(item => slugify(item.title) === params.slug);
...
const CaseStudyDetails = ({caseStudy}) => {
    ...
    return (
      <Layout>
        <Head>
          <title>Case Study Details || Nextdev Labs</title>
        </Head>
                  ...
                  <div className="thumbnail position-relative">
                    ...
                    {/* <div className="shape-group shape-01">
                      <Image
                        width={257}
                        height={179}
                        src= {caseStudy.projectBreif2.image}
                        alt="Shape image"
                      />
                    </div> */}
                    <div className="shape-group shape-02">
                      {/* <Image
                        width={410}
                        height={424}
                        src= {caseStudy?.projectBreif3?.image}
                        alt="Shape image"
                      /> */}
                    </div>
                  </div>
                ...
                <div className="col-lg-8 offset-lg-2">
                  <div className="content">
                    <div className="section-title-inner text-start">
                      ...
                      {caseStudy.solution.description?.map(
                        (solution, index) => (
                          <p
                            key={`project-solution-${index}`}
                            className={`subtitle-2 ${
                              index !==
                              caseStudy.solution.description.length - 1
                                ? "mb--30"
                                : ""
                            }`}
                          >
